    ...
    <fieldset>
        ...
        <form action="actions/a_update.php" method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>Brand</th>
                    <td><input class="form-control" type="text" name="brand" placeholder="Product Brand" value="<?php echo $brand ?>" /></td>
                </tr>

                <tr>
                    <th>Description</th>
                    <td><input class="form-control" type="text" name="description" placeholder="Product Description" value="<?php echo $description ?>" /></td>
                </tr>
